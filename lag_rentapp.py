...
hide_streamlit_style = """
            ...
            footer:after {
                          content:'Created by Lagos House Rent Prediction Team'; 
                          visibility: visible;
                          display: block;
                          position: relative;
...
def predict(Number_of_bedrooms,Number_of_bathrooms,Number_of_toilets,Location,House_type):
    ...
    prediction = xgb_model.predict(pd.DataFrame([[Number_of_bedrooms,Number_of_bathrooms,Number_of_toilets,Location,House_type]],
